...
public class ServerGUI extends JFrame {
    ...
    public ServerGUI() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Server is ready for client requests. Run your client.", "Server Ready", JOptionPane.INFORMATION_MESSAGE);
        ...
        Runnable r1 = () -> {
            ...
            try {
                while (true) {
                    ...
                    appendToChatArea("Client: " + msg, "incoming");
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    private void sendMessage() {
        ...
        if (content.equals("exit")) {
            ...
            appendToChatArea("Server: " + content, "outgoing");
        }
    }
